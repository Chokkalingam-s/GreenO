  ...
  return (
    <div className="grid-container">
      ...
      <Modal show={showModal} onHide={handleClose} centered className="custom-modal-width">
        ...
        <Modal.Body>
          <p className='detailedContent'>{selectedCard?.detailedContent}</p>
        </Modal.Body>
        <Modal.Footer>
