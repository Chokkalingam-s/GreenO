...
import StudentSideBar from "../components/sidebar/StudentSideBar.jsx";
import StudentHeader from "../components/sidebar/StudentHeader.jsx";
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <div className="row">
              <div className="col">
                <div
                  className="card profileCard2 certificateGeneration"
                    ...
                    >
                      {studentDetails
                        ? (
                          <>
                            <h2
                              style={{ marginBottom: "8px", fontSize: "40px" }}
                            >
                              {studentDetails.name}
                            </h2>
                            <p>
