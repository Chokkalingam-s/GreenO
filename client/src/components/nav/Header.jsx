...
export default function Header() {
  ...
  return (
    <header className='w-full grid md:grid-cols-[10%_60%_10%] grid-cols-2 items-center md:justify-evenly md:justify-items-center fixed top-2 z-30 gap-x-36 md:gap-x-0 md:px-0'>
