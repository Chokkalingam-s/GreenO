...
export default function AHome() {
  ...
  return (
    <main className='c_main flex-col space-y-4 py-4 max-w-4xl'>
      <h3 className='head text-center'>Dashboard</h3>
      <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-items-center gap-x-4 gap-y-2'>
