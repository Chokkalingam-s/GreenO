export const plantGrowthData = [
  {
    ...
    detailedContent:
      "In Stage 1, the plant begins its life by focusing on absorbing essential nutrients from the soil through its roots. These nutrients include nitrogen, phosphorus, and potassium, which are crucial for the plant’s early development. The root system plays a critical role in anchoring the plant to the soil, ensuring stability, and providing the foundation for further growth. At the same time, the roots absorb water, which is a vital element for the plant's overall health and cellular processes. As the roots expand deeper into the soil, the plant simultaneously begins to capture sunlight through its leaves. This sunlight is essential for photosynthesis, the process by which the plant converts light energy into chemical energy, producing food that fuels growth. Chlorophyll, the green pigment in leaves, enables the plant to absorb sunlight efficiently, transforming it into glucose and oxygen. This energy production is a continuous cycle, allowing the plant to thrive, grow, and build more complex structures in later stages."
  },
  {
    title: 'Stage 2',
    description: 'The plant develops roots and stems that support further growth.',
    detailedContent:
      "In Stage 2, the plant begins to develop stronger and more robust root systems, as well as stems that serve as the main structural support for future growth. During this phase, the roots grow deeper into the soil, allowing the plant to access water and nutrients from a larger area. This is crucial for the plant's overall stability and health. The development of the stem plays a pivotal role, as it supports the leaves and provides a transport system for nutrients and water. The vascular system within the stem begins to mature, allowing efficient movement of water from the roots to the leaves, and nutrients from the leaves to the rest of the plant. At this stage, the plant is preparing itself for even larger growth and begins to focus on expanding its reach above and below the ground."
  },
  {
    title: 'Stage 3',
    description: 'The plant enters its reproductive phase, producing flowers and fruits.',
    detailedContent:
      "In Stage 3, the plant transitions into its reproductive phase, which is marked by the production of flowers and fruits. This stage signifies maturity as the plant begins to focus on reproduction and the continuation of its species. Flowers play a key role in attracting pollinators such as bees, butterflies, and birds, which facilitate the transfer of pollen. This process is critical for fertilization and the formation of seeds. During this stage, the plant diverts its energy from vegetative growth to the development of flowers, fruits, and seeds. Fruits act as protective structures for seeds and aid in their dispersal, ensuring that the plant's genetic material is spread to new locations for future growth. The plant’s ability to produce flowers and fruits depends on adequate sunlight, water, and nutrients, as well as favorable environmental conditions. This phase represents the culmination of the plant's growth cycle, balancing the energy between sustaining itself and generating new life."
  }
]
...
export const videoData = [
  {
    id: 1,
    src: 'https://www.youtube.com/embed/CBjrdMlZlfE?autoplay=0&mute=1',
    title: 'YouTube video player 1',
    description: 'Plant Growth Process'
  },
  {
    id: 2,
    src: 'https://www.youtube.com/embed/eLACnABG2LM?autoplay=0&mute=1',
    title: 'YouTube video player 2',
    description: 'Major Mistakes We Usually Do'
  }
]
export const icons = {
  person: {
  ...
  sapling: {
    viewBox: '0 0 512 512',
    path: 'M512 32c0 113.6-84.6 207.5-194.2 222-7.1-53.4-30.6-101.6-65.3-139.3C290.8 46.3 364 0 448 0h32c17.7 0 32 14.3 32 32M0 96c0-17.7 14.3-32 32-32h32c123.7 0 224 100.3 224 224v192c0 17.7-14.3 32-32 32s-32-14.3-32-32V320C100.3 320 0 219.7 0 96'
  },
  flag: {
    viewBox: '0 0 448 512',
